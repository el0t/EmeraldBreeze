...
public class DehydratorScreen extends ContainerScreen<DehydratorContainer> {
    private static final ResourceLocation BACKGROUND_TEXTURE =
            new ResourceLocation(EmeraldBreeze.MOD_ID, "textures/gui/container/dehydrator.png");

    public DehydratorScreen(DehydratorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
